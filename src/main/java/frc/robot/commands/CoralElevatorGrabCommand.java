...
// This command causes the End Effector Finger to grab Coral
public class CoralElevatorGrabCommand extends Command {
  private CoralElevatorSubsystem m_subsystem;

  /** D Pad right command, causes End Effector finger to grab coral */
  public CoralElevatorGrabCommand() {
